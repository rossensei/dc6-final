...
<template>
    ...
    <AppLayout>
        <div class="w-full py-6 px-4">
            ...
            <h1 class="text-2xl font-semibold text-gray-700 mb-2">Tasks ({{ props.tasks.total }})</h1>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50" v-for="task in props.tasks.data" :key="task.id">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input :id="'task-checkbox-' + task.id" type="checkbox" :value="task.is_completed" @change="toggleComplete(task.id)" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                            ...
                            <td class="flex items-center px-6 py-4">
                                <Link :href="'/tasks/view-details/' + task.id" class="font-medium text-blue-600 hover:underline">See more details</Link>
                            </td>
                        </tr>
